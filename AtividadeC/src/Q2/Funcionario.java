...
public class Funcionario {
	...
	public String toString(){
		//Bonifica(1000.00);	
		return "Nome: "+ nome+" Departamento de lotação" + depart +" Salário  "+salario+ " Data da entrada "+dataent+ " RG"+RG+" Siuação na empresa "+situacao+"  Bônus"+bonus+ "Total recebido R$";
	}
